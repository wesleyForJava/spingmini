...
public class WesDispatcherServlet3 extends HttpServlet {
...
//    private Map<String,Method> handlerMappings=new HashMap<>();
          ...
          //默认获取所有的public方法
            for (Method method : clazz.getMethods()) {
               if(!method.isAnnotationPresent(WesRequestMapping.class)){ continue;}
                ...
                String regx =(baseUrl+"/"+wesRequestMapping.value())
                        .replaceAll("/+","/");
    ...
    public class HandlerMapping{
        ...
        public HandlerMapping(Pattern url, Method method, Object contoller) {
            this.url = url;
            this.method = method;
